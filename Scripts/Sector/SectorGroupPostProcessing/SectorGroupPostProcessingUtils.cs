...
//         // }
//         
//         public static Dictionary<VertexID, List<Vertex2>> SeparateBySectorId(List<Vertex2> vertices)
//         {
//             return vertices
//                 .GroupBy(v => v.Id.Value)
//                 .ToDictionary(g => new VertexID(g.Key), g => g.ToList());
//         }
//         
